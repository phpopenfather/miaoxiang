...
class User extends Frontend
{
    ...
    protected $noNeedLogin = ['login', 'register', 'mblogin', 'third', 'registermode','codelogin'];
    ...
    public function login()
    {
        ...
        $this->view->assign('logo', '/assets/img/logo-w.png');
        return $this->view->fetch();
    }
