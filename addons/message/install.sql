...
CREATE TABLE IF NOT EXISTS `__PREFIX__message_notice` (
  ...
  `message_attachfile` varchar(255) NOT NULL COMMENT '消息附件',
...
CREATE TABLE IF NOT EXISTS `__PREFIX__message_user` (
  ...
  `send_id` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '发送id',
  `message_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '消息id',
  `is_see` tinyint(1) unsigned NOT NULL DEFAULT '2' COMMENT '是否查看：2未查看, 1已查看',
